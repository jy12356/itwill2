...
<!-- 													<li data-num="4" value="">이용관련 문의</li> -->
	                            ...
	                            <tr>
	                                <td>제목</td>
	                                <td colspan="3">
	                                	<input type="text" name="board_name" required="required" value=<%=article.getSubject() %> />
	                            ...
	                            <tr>
	                            	<td>작성자</td>
	                            	<td colspan="3">
	                            	<input type="text" name="board_name" required="required" value=<%=article.getId() %> />
	                            	</td>
<!-- 	                            	<td class="th">비밀번호</td> -->
<!-- 	                            	<td> -->
...
<!-- 	                            	</td> -->
	                            ...
	                            <tr>
	                                <td>내용</td>
	                                <td colspan="3">
	                                <input type="text" name="board_name" required="required" value=<%=article.getContent() %> />
	                                </td>
	                            </tr>
	                            <tr>
	                                <td>파일</td>
	                    ...
	                    <div class="default-btn-wrap">	
	                        ...
	                        <input type="button" value="삭제" class="btn" onclick="location.href='NoticeBoardDeleteForm.not?num=<%=article.getNum()%>&page=<%=nowPage%>">
