...
<!-- Google Tag Manager -->
<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-KP248RV"></script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KP248RV');</script>
...
<body style="">
	<div class="frame">
		<div class="md">
			<div class="md-title">
				<h3 class="coTitle">최근 구매목록</h3>
				<a href="javascript:parent.goUrl('/mypage.asp?list=_orderbooklist');" class="more">더보기</a>
			</div>
			<!--<p class="no">구매한 작품이 없습니다.</p>--><p class="no">구매한 도서가 없습니다.</p>
		</div>
		<div class="md">
			<div class="md-title">
				<h3 class="coTitle">책바구니</h3>
				<a href="javascript:parent.goUrl('/mypage.asp?list=_cart');" class="more">더보기</a>
			</div><p class="no">책바구니에 담긴 도서가 없습니다.</p>
		</div>
	</div>
...
<script>
$(function () { $("#mypageList", parent.document).height(document.body.scrollHeight)});
</script></body></html>