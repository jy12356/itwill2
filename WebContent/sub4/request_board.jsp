...
<!--                                 <img src="boardimg/one-step.jpg"> -->
                                <td><a href="request_board_update.jsp">안드로이드는 전기양을 꿈꾸는가?</a></td>
                                <td>김바보</td>
                                </td><td>2020/11/12</td>
                            </tr>
						</tbody>
                    ...
                    <div class="btn_inner">
<!--                     	<form action="request_boardSearch.jsp" method="post"> -->
<!-- 						<input type="text" name="search" class="input_box">  -->
<!-- 						<input type="request" value="조회" class="btn"></form> -->
						<input type="text" name="search" class="input_box">
						<a href="request_boardSearch.jsp" class="btn">조회</a>
                    	<a href="request_board_write.jsp" class="btn">도서 신청</a>
                    </div>
                    <div class="paging">
