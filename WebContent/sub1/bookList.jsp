                                ...
                                <li>
                                    <div class="figure">
                                        <a href="BookDetail.bok?isbn="+<%=bookList.get(i).getIsbn()%>>
                                            <span class="rm_br"><img src="<%=bookList.get(i).getImage()%>" alt="도서 이미지 - 식스센스" /></span>
                                            <span class="light"></span>
                                        </a>
                                    </div>
                                    <div class="hot-info">
                                        <p class="hot-title"><a href="BookDetail.bok?isbn="+<%=bookList.get(i).getIsbn()%>><%=bookList.get(i).getTitle() %></a></p>
