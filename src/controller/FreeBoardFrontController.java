...
import action.freeboard.CommentDeleteAction;
import action.freeboard.CommentModifyAction;
...
//			forward.setRedirect(false); // 기본값이 false 이므로 설정 생략 가능
			...
			System.out.println("control 넘어온값 : "+request.getParameter("b"));
		...
		} else if (command.equals("/CommentModify.free")) {
		...
		} else if (command.equals("/CommentDelete.free")) {
