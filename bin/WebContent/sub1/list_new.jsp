			...
			<div class="search-result">
				...
				<div class="tab">
					<ul class="tab-list">
						...
						<li><a href="../sub1/list_new.html" class="on">신간</a></li>
...
『센 강변의 작은 책방』과 『...</p>
										...
										<li>
											...
											<div class="hot-info">
												<p class="hot-title"><a href="/detail.asp?series_num=920029976&page=">마더 앤 마더</a></p>
...
〈뉴...</p>
												...
												<div class="hot-cash"><p>구매 <span>10,400원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
한국식건강연구소 배지영 소장, 차움푸드테라피클리닉...</p>
												...
												<div class="hot-cash"><p>구매 <span>13,860원</span></p>
												</div>
											</div>
										</li>	
										<li>
									...
									<li>
										...
										<div class="hot-info">
											...
											<div class="hot-cash"><p>구매 <span>11,700원</span></p>
											</div>
										</div>
									</li>	
									<li>
...
영문학사 최고의 작가 윌리엄 셰익스피어의 희곡 『로미오와 줄리엣』이 셰익스피어...</p>
												...
												<div class="hot-cash"><p>구매 <span>6,500원</span></p>
												</div>
											</div>
										</li>	
										<li>
											...
											<div class="hot-cash"><p>구매 <span>4,000원</span></p>
											</div>
										</div>
									</li>	
									<li>
...
혼자서도 돈 걱정 없이 당...</p>
												...
												<div class="hot-cash"><p>구매 <span>11,040원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
중요한 ...</p>
												...
												<div class="hot-cash"><p>구매 <span>13,440원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
울먹울먹, 살랑살랑, 끄덕끄덕, 감정이 오르락내리락. 희망이 생기고 기분이 ...</p>
												...
												<div class="hot-cash"><p>구매 <span>12,640원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
울먹울먹, 살랑살랑, 끄덕끄덕, 감정이 오르락내리락. 희망이 생기고 기분이 ...</p>
										...
										<li>
											...
											<div class="hot-cash"><p>구매 <span>6,000원</span></p>
											</div>
										</div>
									</li>	
									<li>
...
《계축일기》는 인목대비 폐비 사건에 대한 궁중의 비사(?史)를 기록한 작품이다. 지존의 위치에 ...</p>
												...
												<div class="hot-cash"><p>구매 <span>4,200원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
이 책은 단단한 시어로 ‘깊이 있는 허무’를 담은 시를 써 온 신현락 시인의...</p>
												...
												<div class="hot-cash"><p>구매 <span>7,800원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
《귀의 성》은 남편의 첩살림을 보지 못하는 본처가 결국 첩을 살해하는 가정 비극을 다룬 작품...</p>
												...
												<div class="hot-cash"><p>구매 <span>4,800원</span></p>
												</div>
											</div>
										</li>	
										<li>
											...
											<div class="hot-cash"><p>구매 <span>6,600원</span></p>
											</div>
										</div>
									</li>	
									<li>
...
“당신의 행복한 삶을 살아가고 있나...</p>
												...
												<div class="hot-cash"><p>구매 <span>8,300원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
안국선, 신채호는 개화기 애국 계몽 운동에 앞장섰던 작가이다. 〈금수회의록〉은 여러 동물이 등장하여 이야기를...</p>
												...
												<div class="hot-cash"><p>구매 <span>4,500원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
이상은 알쏭달쏭한 숫자와 기호, 일상 어법을 넘어선 해석하기 어려운 초현실주의적 시로 ‘문학사의...</p>
										...
										<li>
											...
											<div class="hot-cash"><p>구매 <span>7,500원</span></p>
											</div>
										</div>
									</li>	
									<li>
...
민간에 구비 전승되던 아사달 아사녀 설화를 소재로 한, 비극적인 사랑 이야기를 다룬 역사 소설이다. 군국주의가 심화된 19...</p>
												...
												<div class="hot-cash"><p>구매 <span>5,100원</span></p>
												</div>
											</div>
										</li>	
										<li>
...
<div class="paging"><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=1" class="on fir" data-page-num="1">1</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=2" class="" data-page-num="2">2</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=3" class="" data-page-num="3">3</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=4" class="" data-page-num="4">4</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=5" class="" data-page-num="5">5</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=6" class="" data-page-num="6">6</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=7" class="" data-page-num="7">7</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=8" class="" data-page-num="8">8</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=9" class="" data-page-num="9">9</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=10" class="" data-page-num="10">10</a><a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=11" class="arr next" data-page-num="11"><img src="/images/p-next.png"><span class="hide">다음페이지</span></a>
		<a href="/categorylist.asp?mainclass_num=00&subclass_num=&page=new&pageNum=40" class="arr" data-page-num="40"><img src="/images/p-last.png"><span class="hide">마지막페이지</span></a>
</div>
							</div>
							<script>
							// 리시트 보기 방식 변경
